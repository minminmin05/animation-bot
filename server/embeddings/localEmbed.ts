 ...
 * - Xenova/paraphrase-multilingual-MiniLM-L12-v2 (384 dimensions) - Better for Thai
 * - Xenova/distiluse-base-multilingual-cased-v1 (512 dimensions)
 *
 * To use a different model, set TRANSFORMERS_MODEL in your .env file
 */
